      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        >
          <Link
            ...
            className="bg-[var(--color-primary)] text-white px-8 py-3 rounded-xl shadow-md transition-transform duration-300 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-[var(--color-primary)] focus:ring-opacity-50"
          >
            Get Started
          </Link>
          <Link
            ...
            className="bg-[var(--color-secondary)] text-white px-8 py-3 rounded-xl shadow-md transition-transform duration-300 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-[var(--color-secondary)] focus:ring-opacity-50"
          >
            Documentation
          </Link>
        </motion.div>
